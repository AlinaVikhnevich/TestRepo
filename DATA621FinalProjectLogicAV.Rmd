...
ggplot(global_trend, aes(x = Year, y = mean_life)) +
  ...
  theme(panel.background = element_rect(fill = NA, color = NA),
        ...
        plot.title = element_text(color = "#e5e7eb", size = 20, face = "bold"),
...
pool_diag %>%
  ...
  geom_point(color = "#e0afa0", alpha = 0.4) +
...
fe_diag %>%
  ggplot(aes(x = fitted, y = resid)) +
  geom_point(color = "#7f5539", alpha = 0.4) +
...
ggplot(mixed_diag, aes(sample = resid)) +
  stat_qq(color = "#e0afa0", alpha = 0.6) +
