...
ggplot(global_trend, aes(x = Year, y = mean_life)) +
  ...
  theme(panel.background = element_rect(fill = NA, color = NA),
        ...
        plot.title = element_text(color = "#E0D7C5"),
        axis.text = element_text(color = "#E0D7C5"),
        axis.title = element_text(color = "#E0D7C5"))
```
...
plot_ly(plot_df, x = ~Year, y = ~life_expectancy, color = ~Code, type = "scatter", mode = "lines",
  ...
  layout(title = "Life Expectancy Paths for Selected Countries",
         ...
         font = list(color = "#1f2933", family = "Cormorant Garamond"),
...
df_panel %>%
  ...
  theme(panel.background = element_rect(fill = NA, color = NA),
        ...
        plot.title = element_text(color = "#1f2933"),
