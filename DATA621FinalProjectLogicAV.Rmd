---
title: " Global Life Expectancy - Trends and Panel Modeling"
subtitle: "DATA 621 / Final Project"
...
```{r exploratory-summary, message=FALSE, warning=FALSE}
...
```{r plot-global-trend, message=FALSE, warning=FALSE}
...
```{r plot-country-trends, message=FALSE, warning=FALSE}
...
```{r plot-distribution, message=FALSE, warning=FALSE}
df_panel %>%
...
```{r plot-variability, message=FALSE, warning=FALSE}
...
```{r residuals-pool, message=FALSE, warning=FALSE}
pool_diag <- tibble(
...
```{r residuals-fe, message=FALSE, warning=FALSE}
fe_diag <- tibble(
  fitted = fitted(m3_fe),
...
```{r qq-mixed, message=FALSE, warning=FALSE}
...
```{r plot-random-effects, message=FALSE, warning=FALSE}
...
```{r modelsummary-table, message=FALSE, warning=FALSE}
...
```{r nonparametric}, message=FALSE, warning=FALSE}
