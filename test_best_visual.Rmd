...
steps <- lapply(years_available, function(y) {
  list(
    ...
    args = list(
      ...
      list(
        mode = "immediate",
        frame = list(duration = map_frame_duration, redraw = FALSE),
...
fig$x$frames <- map_frames

fig$x$layout$sliders[[1]]$transition <- list(duration = 0)

fig$x$layout$updatemenus <- list(
  list(
    type = "buttons",
    x = 0.5,
    y = 1.12,
...
fig_income$x$layout$updatemenus <- list(
  list(
    type = "buttons",
    x = 0.5,
    y = 1.1,
...
fig_cont$x$layout$updatemenus <- list(
  list(
    type = "buttons",
    x = 0.5,
    y = 1.08,
