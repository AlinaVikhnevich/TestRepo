...
income_steps <- lapply(income_years, function(y) {
  list(
    ...
    args = list(
      ...
      list(
        mode = "immediate",
        frame = list(duration = income_frame_duration, redraw = FALSE),
...
continent_frames <- lapply(continent_years, function(y) {
  ...
  list(
    name = as.character(y),
    data = lapply(paths, function(p) list(x = p$x, y = p$y))
  )
})
...
continent_steps <- lapply(continent_years, function(y) {
  list(
    ...
    args = list(
      ...
      list(
        mode = "immediate",
        frame = list(duration = continent_frame_duration, redraw = FALSE),
        transition = list(duration = 0)
      )
    )
  )
